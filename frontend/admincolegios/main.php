...
<!--cards and widgets above here-->
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,Hecho de &nbsp;<i class="ti-heart heart"></i> &nbsp;por <a href="https://www.utmachala.edu.ec/portalwp/">Jason Torres, Ricardo Ramón, Darwin Calva, Diego Ojeda, Danny Ramírez y Samuel Calderón</a>
                </div>
            </div>
        </footer>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'ti-gift',
            	message: "Bienvenido  al <b> Sistema Administrativo del Colegio de Bachillerato “Dr. José Ochoa León”</b>"
